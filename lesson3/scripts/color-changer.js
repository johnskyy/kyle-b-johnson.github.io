function changeColor() {
  ...
  document
    .querySelectorAll("#content, header")
    .forEach((el) => (el.style.backgroundColor = "#EEE8EC"));
  document
    .querySelectorAll("a:hover")
    .forEach((el) => (el.style.color = "#FFB845"));
  document
    .querySelectorAll("h1, h2, h3, p")
    .forEach((el) => (el.style.color = "470040"));
  ...
  document
    ...
    .forEach((el) => (el.style.color = "#658361"));
  document
    .querySelectorAll("a:hover")
    .forEach((el) => (el.style.backgroundColor = "#D0DD97"));
  document
    .querySelectorAll("a:hover")
    .forEach((el) => (el.style.color = "#D0DD97"));
  document
    .querySelectorAll("footer a:hover")
    .forEach((el) => (el.style.backgroundColor = "#D0DD97"));
  document
    .querySelectorAll("footer a:hover")
    .forEach((el) => (el.style.color = "#D0DD97"));
